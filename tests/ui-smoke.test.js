...
async function runTests(baseUrl) {
  ...
  if (!startClasses.includes("text-primary-600"))
    throw new Error("Startseite is not active on /");
  ...
  if (!blogClasses.includes("text-primary-600"))
    throw new Error("Blog link not active on /blog");
  ...
  if (before === after)
    throw new Error("CTA hover did not change background color");
